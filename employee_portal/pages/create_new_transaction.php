...
$forms = [
    "Apply Leave", "Request of change of schedule", 
...
<div class="transaction-card" style="width: 500px; margin: 20px auto; background: #fff; border: 1px solid #28a745; border-radius: 4px; overflow: hidden;">
    ...
    <ul class="transaction-list" style="list-style: none; padding: 0; margin: 0;">
        <?php foreach($forms as $form): ?>
            <li><a href="#" class="transaction-item" style="padding: 12px 20px; border-bottom: 1px solid #f1f1f1; color: #007bff; font-weight: 500; font-size: 14px; background: #fff; text-decoration: none; display: block;" onmouseover="this.style.backgroundColor='#f8f9fa'" onmouseout="this.style.backgroundColor='#fff'"><?= $form ?></a></li>
        <?php endforeach; ?>
    </ul>
</div>
<?php
